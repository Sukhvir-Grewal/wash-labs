      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <p className="text-gray-300 mb-8">
            Have questions or want to book a wash? Reach out to us — we’re
          ...
          <ul className="space-y-6">
            <li className="flex items-center space-x-4">
              ...
              <div className="flex flex-col">
                <span className="text-lg">+1 (647) 914-3066</span>
                <span className="text-lg">+1 (437) 991-2206</span>
              </div>
            </li>
            <li className="flex items-center space-x-4">
              <span className="w-10 h-10 flex items-center justify-center bg-orange-500 rounded-full">
              ...
              <span className="text-lg">washlabs.ca@gmail.com</span>
            </li>
            <li className="flex items-center space-x-4">
              <span className="w-10 h-10 flex items-center justify-center bg-orange-500 rounded-full">
                📍
              </span>
              <span className="text-lg">Halifax, Nova Scotia</span>
            </li>
          </ul>
        </div>

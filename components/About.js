      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="order-2 md:order-1">
          ...
          <p className="text-lg text-blue-800 mb-6 leading-relaxed">
            At <span className="text-[#0076ff] font-semibold">Wash <span className="text-[#0076ff]">Labs</span></span>,
          ...
          <p className="text-lg text-blue-800 mb-8 leading-relaxed">
            ...
            we provide <span className="text-[#0076ff] font-semibold">long-lasting shine and protection</span>. 
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            >
              <div className="mb-3 bg-white rounded-full p-2 shadow">
                ...
                <svg width="32" height="32" fill="none" viewBox="0 0 24 24">
                  <path d="M12 6v12m0 0c-2.5 0-3.5-1.5-3.5-2.5S9.5 13 12 13s3.5-1.5 3.5-2.5S14.5 8 12 8" stroke="#0076ff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-[#0076ff] mt-2">Affordable</h3>
            </article>
            ...
            >
              <div className="mb-3 bg-white rounded-full p-2 shadow">
                {/* Sparkle icon */}
                <svg width="32" height="32" fill="none" viewBox="0 0 24 24">
                  <path d="M12 3v3M12 18v3M4.93 4.93l2.12 2.12M16.95 16.95l2.12 2.12M3 12h3M18 12h3M4.93 19.07l2.12-2.12M16.95 7.05l2.12-2.12" stroke="#0076ff" strokeWidth="2" strokeLinecap="round"/>
                  <path d="M12 8.5a3.5 3.5 0 100 7 3.5 3.5 0 000-7z" stroke="#0076ff" strokeWidth="2"/>
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-[#0076ff] mt-2">Perfect Finish</h3>
            </article>
          </div>
        </div>

...
export async function getClient() {
  ...
  // Use a shorter serverSelectionTimeoutMS to avoid 30s hangs
  const options = {
    serverSelectionTimeoutMS: 7000,
    maxPoolSize: 10,
    // MongoDB Atlas best practice
    serverApi: { version: '1', strict: false, deprecationErrors: true },
    // Force TLS for SRV and allow opt-in insecure modes via env, useful behind SSL intercepting proxies
    tls: true,
